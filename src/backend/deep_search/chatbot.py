...
class AlbertChatbot:
    """
    Simplified chatbot implementation for Albert API configuration.
    
    This class now only provides API client configuration.
    All search logic has been moved to views.py for better maintainability.
    """
